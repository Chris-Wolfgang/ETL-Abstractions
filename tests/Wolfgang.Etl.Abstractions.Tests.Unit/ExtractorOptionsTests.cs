...
public class ExtractorOptionsTests
{
    ...
    {
        var sut = new ExtractorOptions(reportingInterval: 25, maximumItemCount: 500, skipItemCount: 3, errorPolicy: SkipPolicy);
    ...
    {
        var viaCtor = new ExtractorOptions();
        var viaInit = new ExtractorOptions { };
    ...
    {
        var sut = new ExtractorOptions(errorPolicy: null);
        Assert.Same(DefaultItemErrorPolicy.Abort, sut.ErrorPolicy);
    }
}

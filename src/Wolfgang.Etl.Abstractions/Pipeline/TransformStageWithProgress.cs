    ...
    where TProgress : notnull
{
    ...
    (
        ...
        where TOut : notnull
    {
        return new TransformStage<TDestination>(NoProgressSourceAsync, _stages).Transform(transformer);
    }
    ...
    {
        return new TransformStage<TDestination>(NoProgressSourceAsync, _stages).Load(loader);
    }

...
public record ExtractorOptions
{
    ...
    /// <c>new ExtractorOptions { … }</c>. Constructor parameters carry no such modifier. Prefer this
    ...
    /// <param name="maximumItemCount">The maximum number of items to be extracted. Defaults to <see cref="int.MaxValue"/>.</param>

    ...
    where TProgress : notnull
{
    ...
    /// paths are one. New code should pass an <see cref="LoaderOptions"/> record, or omit the argument to
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LoaderBase{TDestination, TProgress}"/> class with the supplied
    /// configuration.
    /// </summary>
    /// <param name="options">

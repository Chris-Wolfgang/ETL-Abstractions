...
/// rather than mutated during one. Derived transformers inherit this record to add their own settings, giving a
/// caller a single object to configure the whole stage.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public record TransformerOptions
{
    ...
    /// <c>new TransformerOptions { … }</c>. Constructor parameters carry no such modifier. Prefer this
    ...
    /// <param name="maximumItemCount">The maximum number of items to be transformed. Defaults to <see cref="int.MaxValue"/>.</param>
    ...
    /// <summary>
    /// The maximum number of items to transform. Defaults to <see cref="int.MaxValue"/>.
    /// </summary>
    /// <exception cref="ArgumentOutOfRangeException">The value is less than 1.</exception>
    ...
    /// <summary>
    /// The number of items to skip before transforming. Defaults to <c>0</c>.
    /// </summary>
